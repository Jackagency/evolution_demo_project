#Evolution test automation project
...
- [x] Search testing, using different values
- [x] Main UI check such as сhecking titles on pages
- [x] Page title test
- [x] Page console test
...
## <img src="images/logo/Jenkins.svg" width="25" height="25"  alt="Jenkins"/></a> Jenkins <a target="_blank" href="https://jenkins.autotests.cloud/job/Evolution_demo_project/"> job </a>
